...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/getmembers/^4.10.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/getmembers@^4.10.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/getmembers@4.10.0'
</script>
```
